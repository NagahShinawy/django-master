...
urlpatterns = [
    ...
    path("api/v1/products/update/<int:pk>/", ProductUpdateAPIView.as_view(), name="update"),
    path("api/v1/products/delete/<int:pk>/", ProductDeleteAPIView.as_view(), name="delete"),
